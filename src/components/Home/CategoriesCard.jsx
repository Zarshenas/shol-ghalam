...
function CategoriesCard() {
  return (
    <Box sx={{backgroundColor:"white", maxWidth:"800px",margin:"0 auto 350px auto", padding:"10px", borderRadius:"10px", border:"1px solid #ECECEC",display:"flex", gap:"10px" , alignItems:"center",justifyContent:"space-between"}}> 
